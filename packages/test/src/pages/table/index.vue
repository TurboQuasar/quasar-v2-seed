...
export default defineComponent({
  ...
  setup() {
    ...
    const pagesNumber = computed(() => Math.ceil(paginationParams.rowsNumber / paginationParams.rowsPerPage))
    delay(()=> {
    ...
    return {
      tableLoading,grid,selected,columns,pagesNumber,paginationParams,data
    }
  }
})
</script>
